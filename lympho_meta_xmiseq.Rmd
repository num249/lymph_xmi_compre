...
cancer_types<-c("BRCA","COAD","LUAD","STAD")#THCA
...
for (i in cancer_types){
  for (j in classes){
    ...
    pair<-X1_spearman_ceRNA(pair,mi,g,scc_filter)
...
rm(admat,meta_g,meta_mi,nonmeta_g,nonmeta_mi,meta_delta,nonmeta_delta,wilcox,admat_final)
```
